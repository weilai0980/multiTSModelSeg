...
public class HBaseOp {
	...
	public long regionsCnt(String tabname)
	{
//		
//		HConnection regcon = tableput.getConnection();
//		List<HRegionLocation> regloc = new List<HRegionLocation>();
//		regloc = regcon.locateRegions(Bytes.toBytes(tabname));
//		
////		HRegionInfo reginfor=regloc.getRegionInfo();
////		return reginfor.getRegionId();
		return 1;
	}
...
//	locateRegions(TableName tableName) 
	...
	public long regionStat(String tabname, String rkey) throws IOException {
		HConnection regcon = tableput.getConnection();
		HRegionLocation regloc = regcon.locateRegion(Bytes.toBytes(tabname),
				Bytes.toBytes(rkey));
